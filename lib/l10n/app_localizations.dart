...
abstract class AppLocalizations {
  ...
  /// No description provided for @buildBy.
  ///
  /// In en, this message translates to:
  /// **'Built with Flutter by'**
  String get buildBy;

  /// No description provided for @jessYen.
  ///
  /// In en, this message translates to:
  /// **'Jess Yen'**
  String get jessYen;
  ...
  /// No description provided for @meetMyProjects.
  ///
  /// In en, this message translates to:
  /// **'Meet My Projects'**
  String get meetMyProjects;
  ...
  /// No description provided for @whatMyDesignSkillsInclude.
  ///
  /// In en, this message translates to:
  /// **'What My Design Skills Include'**
  String get whatMyDesignSkillsInclude;
